...
def RetrievingAllGroups(numpag):
    ...
    """
    URLtype = "https://www.enderrock.cat/sona9/grup/"
                    # Url type to save
    AllGrupsLink =[] #OutputList

    for idxnum in range(1,numpag):
        print("evaluating page " +str(idxnum))
        URL = "https://www.enderrock.cat/sona9/grups/pagina"+str(idxnum)  # Url type to retrieve
...
def main():    
    ...
    OuputExcel_FileName= str(year)+"Sona9Grups.csv"
